...
export class Webhooks {
    ...
    public async getWebhook(request: Vocode.GetWebhookRequest): Promise<Vocode.Webhook> {
        ...
        const _response = await core.fetcher({
            url: urlJoin(await core.Supplier.get(this._options.environment), "v1/webhooks"),
            method: "GET",
            headers: {
    ...
    public async listWebhooks(): Promise<Vocode.Webhook[]> {
        const _response = await core.fetcher({
            url: urlJoin(await core.Supplier.get(this._options.environment), "v1/webhooks/list"),
            method: "GET",
            headers: {
                Authorization: await this._getAuthorizationHeader(),
                "X-Fern-Language": "JavaScript",
        ...
        if (_response.ok) {
            return await serializers.webhooks.listWebhooks.Response.parseOrThrow(_response.body, {
                unrecognizedObjectKeys: "passthrough",
                allowUnrecognizedUnionMembers: true,
                allowUnrecognizedEnumValues: true,
                breadcrumbsPrefix: ["response"],
    ...
    public async createWebhook(request: Vocode.WebhookParams): Promise<Vocode.Webhook> {
        const _response = await core.fetcher({
            url: urlJoin(await core.Supplier.get(this._options.environment), "v1/webhooks/create"),
            method: "POST",
            headers: {
                Authorization: await this._getAuthorizationHeader(),
                "X-Fern-Language": "JavaScript",
    ...
    public async updateWebhook(request: Vocode.UpdateWebhookRequest): Promise<Vocode.Webhook> {
        ...
        _queryParams.append("id", id);
        const _response = await core.fetcher({
            url: urlJoin(await core.Supplier.get(this._options.environment), "v1/webhooks/update"),
            method: "POST",
            headers: {
                Authorization: await this._getAuthorizationHeader(),
                "X-Fern-Language": "JavaScript",
