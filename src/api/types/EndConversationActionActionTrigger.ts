...
export type EndConversationActionActionTrigger =
    | Vocode.EndConversationActionActionTrigger.ActionTriggerFunctionCall
    | Vocode.EndConversationActionActionTrigger.ActionTriggerPhraseBased;
