...
export type ExternalActionActionTrigger =
    | Vocode.ExternalActionActionTrigger.ActionTriggerFunctionCall
    | Vocode.ExternalActionActionTrigger.ActionTriggerPhraseBased;
