...
export type SetHoldActionActionTrigger =
    | Vocode.SetHoldActionActionTrigger.ActionTriggerFunctionCall
    | Vocode.SetHoldActionActionTrigger.ActionTriggerPhraseBased;
