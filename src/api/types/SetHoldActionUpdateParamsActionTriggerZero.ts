...
export type SetHoldActionUpdateParamsActionTriggerZero =
    | Vocode.SetHoldActionUpdateParamsActionTriggerZero.ActionTriggerFunctionCall
    | Vocode.SetHoldActionUpdateParamsActionTriggerZero.ActionTriggerPhraseBased;
